...
The missing fungal sequences in the databases do not interfere with the precision-recall curves (e.g. [***Figure-S2a, Figure-S2b***](../attachments/supplements/figure_s2.md "Supplements, Figure 2")).
...
The abundances for the species in the samples classified using the default databases can be seen in [***Tables-S1***](../attachments/supplements/table_s1.md "Supplements, Table 1"), [***-S2***](../attachments/supplements/table_s2.md "Supplements, Table 2"), [***-S3***](../attachments/supplements/table_s3.md "Supplements, Table 3") and [***-S4***](../attachments/supplements/table_s4.md "Supplements, Table 4"). The protein-based tools Kaiju and Diamond associate a minority of reads to the species in the sample. For Diamond (GridION364), the percentage of assigned reads is between 0 and 1% with the exception of *Listeria monocytogenes* with 2.89%. However, considering the genus level, Diamond is able to identify more reads belonging to a genus included in the dataset. The genera with the most abundances are *Listeria*, (9.459%), *Staphylococcus* (7.004%) and *Pseudomonas* (4.54%), see [***Figure-S3***](../attachments/supplements/figure_s3.md "Supplements, Figure 3"). Two of the corresponding species in this dataset are gram-positive, whereas *Pseudomonas aeruginosa* is gram-negative, this proportion is applicable for the low abundances genera as well, hence there does not seem to be a trend which gram-species can be better classified with Diamond. <br>
Kaiju on the other hand assigns more reads to gram-positive species (4.151% - 12.503% of abundance), whereas gram-negative species achieve fewer assigned reads (1.104% - 2.124%) in GridION364. This is also true for the PromethION sample, the classified gram-positive species abundances range from 3.98% to 12.033%, whereas the gram-negative species have 1.111% to 2.101% of reads assigned to ([***Table-S2***](../attachments/supplements/table_s2.md "Supplements, Table 2"), [***Figure 3a***](../stats/pics/gridion364_default.kaiju.piechart.jpeg "(a) GridION364: Piechart for Classification Results of Kaiju (default)")). <br>
...
Kraken2 reached similar classification results with the the custom database ([***Table-S9***](../attachments/supplements/table_s9.md "Supplements, Table 9")). <br>
...
[***Table-S1: Overview of abundances for GridION364, Default Database***](../attachments/supplements/table_s1.md "Supplements, Table 1")

[***Table-S2: Overview of abundances for PromethION365, Default Database***](../attachments/supplements/table_s2.md "Supplements, Table 2")

[***Table-S3: Overview of abundances for GridION366, Default Database***](../attachments/supplements/table_s3.md "Supplements, Table 3")

[***Table-S4: Overview of abundances for PromethION367, Default Database***](../attachments/supplements/table_s4.md "Supplements, Table 4")

[***Table-S5: Abundances of classified species, Diamond (custom)***](../attachments/supplements/table_s5.md "Supplements, Table 5")

[***Table-S6: Abundances of classified species, Kaiju, (custom)***](../attachments/supplements/table_s6.md "Supplements, Table 6")

[***Table-S7: Abundances of classified species, Centrifuge (custom)***](../attachments/supplements/table_s7.md "Supplements, Table 7")

[***Table-S8: Abundances of classified species, CLARK (custom)***](../attachments/supplements/table_s8.md "Supplements, Table 8")

[***Table-S9: Abundances of classified species, Kraken2 (custom)***](../attachments/supplements/table_s9.md "Supplements, Table 9")

[***Table-S10: Overview of abundances for GridION364, Custom Database***](../attachments/supplements/table_s10.md "Supplements, Table 10")

[***Table-S11: Overview of abundances for PromethION365, Custom Database***](../attachments/supplements/table_s11.md "Supplements, Table 11")

[***Table-S12: Overview of abundances for GridION366, Custom Database***](../attachments/supplements/table_s12.md "Supplements, Table 12")

[***Table-S13: Overview of abundances for PromethION367, Custom Database***](../attachments/supplements/table_s13.md "Supplements, Table 13")
