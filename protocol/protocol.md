...
BugSeq is can only be briefly compared to the other tools since the cloud-service has a different database. The AUPR is!!!, which is in the scope of...
...
Considering BugSeq, it is possible that the tools !!!
...
This trend can be observed within the custom databases as well (***Table 11***). Kraken2 is still fastest with similar times. The runtimes for Kaiju do not change much either with the custom database. This is is true for Diamond and GridION364 as well. <br>
