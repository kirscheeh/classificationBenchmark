...
The other option is a specification of the sample type. Since this dataset includes two fungal sequences, the option <tt>bacterial isolates</tt> could not be used, therefore the default <tt>Generic</tt> sample type has been chosen.
