...
#
#   Copyright 2013-2018, Rachid Ounit <rouni001@cs.ucr.edu>
...
RANK=0
FSCRPT=$(readlink -f "$0")
LDIR= "/mnt/prostlocal/programs/clark/1.2.5/" #$(dirname "$FSCRPT")
